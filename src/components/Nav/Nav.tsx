...
const Nav = (props:props) => {
    return (
        <div className={`sidebar ${props.isCollapse ? "sidebar__collapse" : ""}`}>
            ...
            <button className="sidebar__btn" onClick={props.toggleVisibility}><FontAwesomeIcon icon={faDungeon} className="sidebar__svg-toggle" /><span className="sidebar__svg-text">Adventure</span> <span className="sidebar__svg-text-2">Go?</span></button>
            {props.isVisible && <Links   />}
